...
- [User guide](docs/usage.md) — install, register, automatic mode, troubleshooting, uninstall.
- [Architecture decisions](docs/adr/README.md) — the _why_ behind the design (MDM-safe tooling,
  caffeinate flags, tool surface, distribution).
- [Contributing](CONTRIBUTING.md) — dev setup, commit conventions, how a PR gets merged.
- [Security policy](SECURITY.md) — reporting, the no-shell invariant, supply-chain notes.
- [Changelog](CHANGELOG.md) — notable changes per release.

## Support

`mac-awake-mcp` is free and MIT-licensed. If it saves your screen from locking
mid-task, here are a few ways to help:

- Star the repository — the cheapest way to say thanks and boost visibility.
- [Sponsor the project on GitHub](https://github.com/sponsors/roccodebellis).
- Report bugs and edge cases, especially across different macOS / MDM setups.
